...
| 6 | HWPX/DOCX/HTML parity | `python3 tests/validate_renderer_spike.py`; inspect `.gjc/…/artifacts/g005-e2e.json` | Real 3-format files, markers at canonical locations, identical content_fingerprint | ✅ real files |
